 ...
 <div class="container">
    ...
    ?>
 	<?php	
        ...
        if(empty($errors)){
            $query="UPDATE partial_retraction SET  FullName='".$name."' WHERE Client_id='".$_SESSION['id']."'";
...
<?php if (!empty($message)) {
        ...
        <?php if (!empty($errors)) {
 			...
 			<form action="updateParretr.php" method="post" id="update" >
