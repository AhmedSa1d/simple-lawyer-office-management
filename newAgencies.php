 ...
 <div class="container">
  	<div class="row text-center">
 		...
 		<div class="col-md-8 headCon">
           <a href="newAgencies.php"><p> التوكيلات الجديدة </p> </a>
        </div>
 		<div class="col-md-2"></div>
 	</div>
 	<div class="row text-center">
 		...
 		<div class="col-md-8 text-center  contnt" id="tabs">
 			...
 			<ul class="text-center" dir="rtl">
				<li><a href="#tabs-1">بحث عن توكيل  جديد</a></li>
				<li><a href="#tabs-2"> اضافة توكيل جديد </a></li>

				

			</ul>
            <div  class="contnt" id="tabs-1">
            	<form action="serNewagen.php" method="post" id="search" >
	            	<input type="text" name="search" id="NewAgenSearch" placeholder="ابحث عن توكيل " class="form-control formstyle " required="" />
            ...
            <div class="contnt" id="tabs-2">
            	...
            	<form action="addNewagen.php" method="post" id="addagen" >
