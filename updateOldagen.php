 ...
 <div class="container">
    ...
    ?>
 	<?php	
        ...
        if(empty($errors)){
            $query="UPDATE oldagencies SET  FullName='".$name."', OldAgenciesNumber='".$number."' WHERE Agencies_Id='".$_SESSION['id']."'";
...
<?php if (!empty($message)) {
        ...
        <?php if (!empty($errors)) {
 			...
 			<form action="updateOldagen.php" method="post" id="update" >
