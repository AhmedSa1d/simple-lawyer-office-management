 ...
 <div class="container">
    ...
    ?>
 	<?php	
        ...
        if(empty($errors)){
            $query="UPDATE criminal_retraction SET  FullName='".$name."' WHERE Client_id='".$_SESSION['id']."'";
...
<?php if (!empty($message)) {
        ...
        <?php if (!empty($errors)) {
 			...
 			<form action="updateComretr.php" method="post" id="update">
