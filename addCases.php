 ...
 <?php  require_once("includes/functions.php")?>
 	<?php	
       ...
       // $name=  trim(mysql_prep($_POST['name']));
        ...
        if(empty($errors)){
            global $connection;
            $query2="ALTER TABLE finished_cases DROP Client_id";
            $query3="ALTER TABLE finished_cases ADD Client_id int not null auto_increment primary key first";
            $result2=  mysql_query($query2,$connection);
            $result3=  mysql_query($query3,$connection);
            $query="INSERT  INTO finished_cases(FullName) VALUES('".$_POST['name']."') ";
